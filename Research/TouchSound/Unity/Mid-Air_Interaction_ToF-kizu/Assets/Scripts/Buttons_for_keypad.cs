...
public class Buttons_for_keypad : MonoBehaviour
{
    ...
    private GameObject KeyPadScene;
    private KeyPadscene Ks;

    public void Start()
    {
        KeyPadScene = GameObject.Find("KeyPadScene");
        Ks = KeyPadScene.GetComponent<KeyPadscene>();
    ...
    public void Update()
    {
        if (is_touch)
        {
            ...
            else
            {
                ...
                display.Update_display(text.text);
                //Debug.Log(text.text);
                highlight = true;
            }
        }
