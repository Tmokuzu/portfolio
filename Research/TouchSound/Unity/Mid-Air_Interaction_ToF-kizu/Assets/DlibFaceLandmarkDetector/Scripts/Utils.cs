...
namespace DlibFaceLandmarkDetector
{
    public static class Utils
    {
        ...
        * Sets the debug mode.
        * <p>
        * <br>if true, The error log of the Native side DlibFaceLandmarkDetector will be displayed on the Unity Editor Console.However, if throwException is true, DlibException is thrown instead of calling Debug.LogError (msg).
        ...
        * 
        * @param debugMode if true, The error log of the Native side DlibFaceLandmarkDetector will be displayed on the Unity Editor Console
        * @param throwException if true, DlibException is thrown instead of calling Debug.LogError (msg).
        */
