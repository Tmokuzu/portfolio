...
## Properties
# filaNames
xml = "../scenes/positioncheck.xml"
#xml = "../scenes/display.xml"
outputFolderName = "position"
...
glass_roughs = [0.0005] #[0.003, 0.004]
mirror_roughs = [0.0005] #[0.002, 0.003]

#print(mirror_roughs)
#quit()
sens = [30]
display_distance = [15]#[15, 20, 25, 30, 35, 40, 45]
sample_count = 64#1024
render_w = 512#1080#2160
render_h = 512#720#1440
